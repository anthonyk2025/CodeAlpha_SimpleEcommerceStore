...
const products = [
  ...
  { user: null, name: 'Coffee Mug', image: 'https://bigsale-lb.com/cdn/shop/files/White_BrownCeramicMugs.jpg?v=1752658524', description: 'A sturdy and stylish ceramic mug, perfect for your morning coffee or tea.', price: 8.50, countInStock: 25, category: 'Home Goods' },
  // --- THIS IS THE CORRECTED PRODUCT ---
  { 
    user: null, 
    name: 'QuickBoil Electric Kettle', // Correct name
    image: 'https://www.mtechleb.com/cdn/shop/files/LPRGKTBK_LePresso360TransparentQuick-BoilGlassKettle.jpg?v=1749812191', // Correct image field
    description: '1.7-liter stainless steel electric kettle that boils water in minutes.', 
    price: 34.99, 
    countInStock: 18, 
    category: 'Home Goods', 
    badge: 'Best Seller' 
...
const importData = async () => {
  try {
    // It's safer to connect inside the function
    await connectDB();
